...
<button style="width: {width}; height: {height}" on:click={onClick} class="container">
  <svg on:click={() => $route = Home} class="gear-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
