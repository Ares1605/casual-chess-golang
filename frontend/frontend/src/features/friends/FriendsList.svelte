...
import CustomScroller from "../../common/CustomScroller.svelte";
...
<!-- {#if $userProfile} -->
<!--   <UserProfile reference={$userProfile.reference} user={$userProfile.user} /> -->
<!-- {/if} -->
