<script lang="ts">
  ...
  import { ValidateUsername } from "../wailsjs/go/main/App";
      ...
      ValidateUsername($user, input.value)
        ...
        .catch (error => {
          notifs.add({
            ...
            "title": "Couldn't validate username",
...
<div class="container">
  ...
  <div class="username-cont" class:valid={valid} class:invalid={valid === false}>
    <div class="username">
      ...
      <div class="stop-cont">
        <svg class="stop" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="username-exists-cont">
      <span class="username-exists">{invalidReason}</span>
    </div>
  </div>
</div>
...
<style>
  ...
  .username-header svg path {
    transition: fill .2s;
  }
  .username-header:hover svg path {
    fill: #d4bea1;
  }
  .username-cont {
    margin: auto;
